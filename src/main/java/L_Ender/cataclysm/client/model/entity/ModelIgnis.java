...
public class ModelIgnis extends AdvancedEntityModel<Ignis_Entity> {
    ...
    public void animate(Ignis_Entity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        if(entity.getIsBlocking()) {
            ...
            //animator.move(right_hand, 1.5f, 0, 0);
            animator.rotate(right_fist, (float) Math.toRadians(-22.5F), 0, 0);
        ...
        animator.setAnimation(Ignis_Entity.COMBO_SWING_ATTACK);
        animator.startKeyframe(8);
        animator.rotate(root, 0, (float)Math.toRadians(47.5F), 0);
        animator.rotate(upperbody, (float)Math.toRadians(2.5F), (float)Math.toRadians(-27.5F),  (float)Math.toRadians(-17.5F));
        animator.rotate(head, (float)Math.toRadians(-5F), (float)Math.toRadians(-5F), (float)Math.toRadians(22.5F));
        animator.rotate(right_arm_joint, (float)Math.toRadians(22.5F), (float)Math.toRadians(-25F), (float)Math.toRadians(40F));
        animator.rotate(right_hand, (float)Math.toRadians(25F), 0, 0);
        animator.rotate(right_fist, (float)Math.toRadians(40F), 0, 0);
        animator.rotate(left_arm_joint, (float)Math.toRadians(27.5F), (float)Math.toRadians(-45F), (float)Math.toRadians(-25F));
        animator.rotate(left_hand, (float)Math.toRadians(20F), (float)Math.toRadians(-15F), (float)Math.toRadians(-15F));
        animator.endKeyframe();
        animator.setStaticKeyframe(12);

        animator.startKeyframe(8);
        animator.rotate(root, 0, (float)Math.toRadians(-70F), 0);
        animator.rotate(upperbody, (float)Math.toRadians(-22.5F), (float)Math.toRadians(-60F),  (float)Math.toRadians(-25F));
        animator.rotate(lowerbody, (float)Math.toRadians(7.5F), 0, 0);
        animator.rotate(head, (float)Math.toRadians(10F), (float)Math.toRadians(60F), (float)Math.toRadians(7.5F));
        animator.rotate(right_arm_joint, (float)Math.toRadians(-7.5F), (float)Math.toRadians(15F), (float)Math.toRadians(75F));
        animator.rotate(right_hand, (float)Math.toRadians(-37.5F), (float)Math.toRadians(17.5F), (float)Math.toRadians(7.5F));
        animator.rotate(right_fist, (float)Math.toRadians(-20F), 0, 0);
        animator.rotate(left_arm_joint, (float)Math.toRadians(45F), (float)Math.toRadians(-42.5F), (float)Math.toRadians(-15F));
        animator.rotate(left_hand, (float)Math.toRadians(-55F), (float)Math.toRadians(-15F), (float)Math.toRadians(-15F));
        animator.endKeyframe();
        animator.setStaticKeyframe(12);

        animator.startKeyframe(8);
        animator.rotate(root, 0, (float)Math.toRadians(-70F), 0);
        animator.rotate(upperbody, (float)Math.toRadians(-22.5F), (float)Math.toRadians(-67.5F),  (float)Math.toRadians(-25F));
        animator.rotate(lowerbody, (float)Math.toRadians(12.5F), 0, 0);
        animator.rotate(head, (float)Math.toRadians(10F), (float)Math.toRadians(60F), (float)Math.toRadians(7.5F));
        animator.rotate(right_arm_joint, (float)Math.toRadians(-12.5F), (float)Math.toRadians(15F), (float)Math.toRadians(75F));
        animator.rotate(right_hand, (float)Math.toRadians(-35F), (float)Math.toRadians(17.5F), (float)Math.toRadians(7.5F));
        animator.rotate(right_fist, (float)Math.toRadians(-20F), 0, 0);
        animator.rotate(left_arm_joint, (float)Math.toRadians(45F), (float)Math.toRadians(-50F), (float)Math.toRadians(-15F));
        animator.rotate(left_hand, (float)Math.toRadians(-55F), (float)Math.toRadians(-15F), (float)Math.toRadians(-15F));
        animator.endKeyframe();
        animator.setStaticKeyframe(12);
        ...
        animator.rotate(upperbody, (float)Math.toRadians(12.5F), (float)Math.toRadians(20F),  (float)Math.toRadians(12.5F));
        animator.rotate(head, (float)Math.toRadians(10F), (float)Math.toRadians(-2.5F), (float)Math.toRadians(7.5F));
        animator.rotate(right_arm_joint, (float)Math.toRadians(30F), (float)Math.toRadians(25F), (float)Math.toRadians(37.5F));
        animator.rotate(right_hand, (float)Math.toRadians(-7.5F), (float)Math.toRadians(17.5F), (float)Math.toRadians(7.5F));
        animator.rotate(right_fist, (float)Math.toRadians(45F), 0, 0);
        animator.rotate(left_arm_joint, (float)Math.toRadians(45F), (float)Math.toRadians(-30F), (float)Math.toRadians(-17.5F));
        animator.rotate(left_hand, (float)Math.toRadians(-55F), (float)Math.toRadians(-15F), (float)Math.toRadians(-15F));
        animator.endKeyframe();
    ...
    private void poke(int start, int setstatic, int reset){
