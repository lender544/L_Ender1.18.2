...
public class Ignis_Entity extends Boss_monster {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(SHIELD_DURABILITY, 3);
    ...
    public void tick() {
        ...
        setYRot(yBodyRot);
        if (this.isAlive()) {
            if (!isNoAi() && this.getAnimation() == NO_ANIMATION && this.getShieldDurability() < 1 && !this.getIsShieldBreak() && blockingProgress == 10) {
                ...
                } else if (!isNoAi() && this.getAnimation() == NO_ANIMATION && this.distanceTo(target) < 5.5F && this.getRandom().nextFloat() * 100.0F < 6f) {
