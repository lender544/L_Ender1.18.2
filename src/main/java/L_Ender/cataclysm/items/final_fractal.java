...
public class final_fractal extends SwordItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        tooltip.add(new TranslatableComponent("item.cataclysm.final_fractal.desc").withStyle(ChatFormatting.DARK_GREEN));
        tooltip.add(new TranslatableComponent("item.cataclysm.wip.desc").withStyle(ChatFormatting.DARK_GREEN));
    }
}
