...
public class ModelIgnis extends AdvancedEntityModel<Ignis_Entity> {
    ...
    public void animate(Ignis_Entity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.rotate(right_arm_joint, 0, 0, (float)Math.toRadians(15F));
        animator.rotate(right_hand, (float)Math.toRadians(-7.5F), 0, 0);
        animator.rotate(head, (float)Math.toRadians(5F), (float)Math.toRadians(-5F), (float)Math.toRadians(-2.5F));
        animator.rotate(left_arm_joint, (float)Math.toRadians(37.5F), (float)Math.toRadians(2.5F), 0);
        animator.rotate(left_hand, (float)Math.toRadians(-10F), 0, 0);
        ...
        animator.rotate(left_arm_joint, (float)Math.toRadians(17.5F), (float)Math.toRadians(-40F), 0);
        animator.rotate(left_arm, 0, (float)Math.toRadians(2.5F), (float)Math.toRadians(7.5F));
        animator.rotate(left_hand, (float)Math.toRadians(-17.5F), 0, 0);
        animator.endKeyframe();
        animator.setStaticKeyframe(15);

        animator.startKeyframe(5);
        animator.rotate(root, 0, (float)Math.toRadians(-65F), 0);
        animator.rotate(upperbody, (float)Math.toRadians(-10F), (float)Math.toRadians(-27.5F), (float)Math.toRadians(-15F));
        animator.rotate(right_arm_joint, (float)Math.toRadians(-35F), (float)Math.toRadians(-22.5F), (float)Math.toRadians(17.5F));
        animator.rotate(right_hand, (float)Math.toRadians(30F), (float)Math.toRadians(97.5F), (float)Math.toRadians(12.5F));
        animator.rotate(right_fist, (float)Math.toRadians(2.5F), 0, 0);
        animator.rotate(head, (float)Math.toRadians(5F), (float)Math.toRadians(70F), 0);
        animator.rotate(left_arm_joint, (float)Math.toRadians(60F), (float)Math.toRadians(-25F), (float)Math.toRadians(-2.5F));
        animator.rotate(left_hand, (float)Math.toRadians(-20F), (float)Math.toRadians(-23.5F), (float)Math.toRadians(-10F));
        animator.endKeyframe();
        animator.setStaticKeyframe(15);
